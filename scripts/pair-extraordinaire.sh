...
PR_URL=$(gh pr create --title "Pair PR $TS" --body "Pair Extraordinaire via git-cli")
gh pr merge "$PR_URL" --merge --admin
echo "Success! Checked your profile for Pair Extraordinaire: https://github.com/0xking1jaa?tab=achievements"

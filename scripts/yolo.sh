...
PR_URL=$(gh pr create --title "YOLO PR $TS" --body "YOLO update for git-cli")
gh pr merge "$PR_URL" --merge --admin
echo "Success! Checked your profile for YOLO: https://github.com/0xking1jaa?tab=achievements"
